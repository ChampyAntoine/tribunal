...
Vous pouvez retouvez 68 avocats à l'Ordre des avocats: Esplanade du Palais de Justice, 08000 CHARLEVILLE-MÉZIÈRES<p>
		</article>
		
		<article class="notaire">
			<h2>Les Notaires</h2>
			<p>En droit français, le notaire est un officier public, nommé par décision du Garde des Sceaux. Il est, à ce titre, investi d’une délégation de puissance publique. Le notaire éclaire le consentement des parties et a le pouvoir de conférer un caractère authentique à tous les actes qui lui sont demandés. Il assure également la conservation des minutes.</p>
		</article>
